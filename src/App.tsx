...
import { getSchedule } from './utils/scheduler';
    ...
    <div className="flex flex-col h-full px-5 py-2 overflow-y-auto">
      ...
      <div className="hidden md:flex items-center gap-3 mb-8">
        ...
        <div>
          ...
          <span
            title="Enquanto durar a reforma"
            className="inline-block mt-1.5 text-[9px] font-bold text-amber-800 bg-amber-100 border border-amber-300 px-1.5 py-0.5 rounded uppercase tracking-wider cursor-help select-none"
          >
            ⚠ Provisória
          </span>
        </div>
            ...
            <div className="flex items-center gap-2 min-w-0 flex-1">
              ...
              <div className="flex flex-col min-w-0">
                ...
                <div className="flex items-center gap-1 mt-0.5 min-w-0">
                  <p className="text-[9px] text-text-secondary font-medium tracking-wider truncate uppercase">JD. SÃO LUIZ · 2026</p>
                  <span
                    title="Enquanto durar a reforma"
                    className="shrink-0 text-[8px] font-bold text-amber-800 bg-amber-100 border border-amber-300 px-1 py-px rounded uppercase tracking-wider cursor-help select-none"
                  >
                    Provisória
                  </span>
                </div>
        ...
        <div className="p-4 sm:p-6 lg:p-8 flex-1 max-w-5xl mx-auto w-full bg-gray-50 pb-24" id="schedule-container">
          ...
          <div id="export-header" className="hidden items-center gap-3 mb-6 pb-4 border-b border-gray-200">
            ...
            <div>
              ...
              <p className="text-xs text-text-secondary mt-1 font-medium tracking-wider">JD. SÃO LUIZ · 2026 · PROVISÓRIA · ENQUANTO DURAR A REFORMA</p>
            </div>
          </div>
